<section class="yogis">
  <h2 class="text-center text-3xl">Yogis</h2>
  <div class="flex flex-wrap items-center justify-center m-2 yogis-list">
    @foreach($yogi_items as $yogi_item)
      <div class="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
          ...
          -->
          <img class="relative w-48 rounded-full border-8 border-white shadow" src="{{ $yogi_item['thumbnail_url'] }}" alt="{{ $yogi_item['slug'] }}">
        </div>
